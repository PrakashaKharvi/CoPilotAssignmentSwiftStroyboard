...
struct ArticleItemModelDTO: Codable {
    ...
    func toDomain() -> ArticleItemModel {
        return ArticleItemModel(title: title, Subtitle: Subtitle, authorName: authorName, description: description, hero: hero, articleId: articleId, categoryId: categoryId, authorId: authorId, articleType: articleType, tags: tags)
    }
}
